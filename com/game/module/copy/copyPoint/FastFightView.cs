...
{
	public class FastFightView : BaseView<FastFightView>
	{
		...
		protected override void HandleAfterOpenView ()
		{
            ...
            //end 德索添加
			InitFastFightView ();
			Singleton<CopyPointMode>.Instance.ApplyFastFight (Singleton<CopyPointMode>.Instance.selectedCopyPoint, 
			                                                  (byte)Singleton<CopyPointMode>.Instance.fightNum);
...
//				fightResult[i].transform.localPosition = new Vector3(0, 0, 0);
		...
		{
			//初始化
			fastFightTimes = Singleton<CopyPointMode>.Instance.fightNum;
			durTime = 1;
			curFightTimes = 0;
