 ...
 * history:  created by qi luo   2014/05/07 05:29:41 
 * function: 指引瞬移学习
 * *******************************************************/

namespace com.game.module.Guide.GuideLogic
{
    public class GuideSkillRollLearn : GuideSkillOpen
    {
        ...
        {
            SkillView.Instance.CurrentGuideId = GuideType.GuideSkillRollLearn;
        }
